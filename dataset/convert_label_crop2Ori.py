...
def convert_label():
	...
	path_predicted_labels = '../output/eval_rslt/result'
	target = 'test'
	path_diff_files = f'preprocessed/path_for_{target}/diff_gt/'
	path_save_rslt_final = f'preprocessed/path_for_{target}/converted_gt/'
