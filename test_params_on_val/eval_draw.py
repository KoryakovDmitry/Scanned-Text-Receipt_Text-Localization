...
def main(model_path, img_folder, img_folder1, save_path, gpu_id):
    ...
    img_paths1 = [os.path.join(img_folder1, x) for x in os.listdir(img_folder1)]
    model = Pytorch_model(model_path, gpu_id=gpu_id)
    total_frame = 0.0
    total_time = 0.0
    for img_path, img_path1 in tqdm(zip(img_paths, img_paths1)):
        ...
        total_frame += 1
        total_time += t
        img = draw_bbox(img_path1, boxes_list, color=(255, 0, 0))
...
if __name__ == '__main__':
    ...
    img_path1 = 'output/eval_rslt_val_cr/img'
    ...
    # save_path = 'output/combined_val_cr_fl/txt'
    ...
    # save_path = '../dataset/preprocessed/path_for_val/converted_gt'
    ...
    save_path = main(model_path, img_path, img_path1, save_path, gpu_id=gpu_id)
